/* ══════════ CONNECTION ══════════ */
const username="Aakash",password="Aqua@9090",encoded=btoa(username+":"+password);
const BASE="https://aquaagri.in/aquauser/ODataV4/Company('Aquagri%20Processing%20Pvt%20Ltd')";
const CLE_API=BASE+"/customerLedgerEntry",CUSTOMER_API=BASE+"/customer_API";
